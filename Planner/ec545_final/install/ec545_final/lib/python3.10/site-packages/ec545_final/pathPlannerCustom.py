...
class RobotController(Node):
    ...
    def pose_callback2(self, msg):
        ...
        theta += adjust_angle_difference(theta-self.prevTheta)
    ...
    def calculate_velocity_command(self, path):
        ...
        cmd_vel.angular.z = angle_error # Adjust the gain factor as necessary
...
def main(args=None):
    ...
    waypoints_turtle1 = [Pose(x=0.0, y = 0.0, theta = 0.0)]
    controller_turtle1 = RobotController(1, waypoints_turtle1, endServoState=1)


    # ... Initialize other turtle controllers
    controllers = [controller_turtle1]
